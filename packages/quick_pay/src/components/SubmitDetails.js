...
class SubmitDetails extends Component {
  ...
  componentDidMount() {
    ...
    dispatch(
      trackQPevent(`${step}_loading`, anonUserID, {
  ...
  onPreview(ev) {
    ...
    dispatch(
      trackQPevent("show_submit_confirm", anonUserID, {
        submissionId: createdSubId
      })
    );
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (
      this.props.analyseInProgress !== nextProps.analyseInProgress &&
      nextProps.analyseInProgress === false
    ) {
      this.props.dispatch(
        trackQPevent(`${this.props.step}_loaded`, this.props.anonUserID, {
          submissionId: this.props.createdSubId
        })
      );
      if (windowGlobal) {
  ...
  render() {
    ...
    console.log(enable_subs, sub_packages, "subdetails");
        ...
        <div className={styles.columns}>
          ...
          >
            ...
            >
              ...
              <div className={styles.loading} style={{ marginTop: "1rem" }}>
                {" "}
              </div>
    ...
    let price = "0.00";
    let message =
      "Since I’m just a bot, I couldn’t figure out the amount due. Please enter the correct amount below";
    ...
    const canSubmit =
      this.state.card_no &&
      this.state.card_exp &&
      this.state.cvc_number &&
      this.state.postal &&
      this.state.email &&
      valCheck > currency("2.00").value;
    ...
    if (valCheck > currency("10,000").value) {
        ...
        <div className={styles.columns}>
          <div className={`${styles.column} ${styles.col12}`}>
            <div className={styles.empty}>
              <p className={`${styles.emptyTitle} ${styles.h3}`}>
                💰That's amount is higher than what we can process at the moment
                💰
              </p>

              <p className={styles.emptySubtitle}>
                Please email{" "}
                <a href="mailto:team@papergov.com" target="_top">
                  team@papergov.com
                </a>{" "}
                for more details
              </p>
      ...
      message =
        "Looks like the amount to pay is too low. Since I’m just a bot & may get this wrong, feel free to edit.";
      if (userPrice) {
