      ...
      <div className="above-left" >
        <div style={{ width: '128px', margin: '16px' }}>
          <svg width="128" height="128" fill="none"  >
            ...
            <polyline stroke-width="8" fill="none" stroke="#5627ff" points="0 128 0 0 128 0"></polyline>
      ...
      <div className="above-right" >
        <div style={{ width: '128px', margin: '16px' }}>
          <svg width="128" height="128" fill="none"  >
            ...
            <polyline stroke-width="8" fill="none" stroke="#5627ff" points="0 0 128 0 128 128"></polyline>
      ...
      <div className="below-left" >
        <div style={{ width: '128px', margin: '16px' }}>
          <svg width="128" height="128" fill="none"  >
            ...
            <polyline stroke-width="8" fill="none" stroke="#5627ff" points="0 0 0 128 128 128"></polyline>
      ...
      <div className="below-right" >
        <div style={{ width: '128px', margin: '16px' }}>
          <svg width="128" height="128" fill="none"  >
            ...
            <polyline stroke-width="8" fill="none" stroke="#5627ff" points="0 128 128 128 128 0"></polyline>
