  ...
  render() {
    ...
    if (qaList) {
      tabContent.push(
        <Fragment>
          <h4>FAQs</h4>
          <p className={classes.ser_detail_cardContent} id={`faqs`}>
            {qaList}
          </p>
        </Fragment>
      );
    ...
    if (stepList) {
      tabContent.push(
        <Fragment>
          <h4>Steps</h4>
          <p className={classes.ser_detail_cardContent} id={`steps`}>
            {stepList}
          </p>
        </Fragment>
      );
    ...
    if (formList) {
      tabContent.push(
        <Fragment>
          <h4>Forms</h4>
          <p className={classes.ser_detail_cardContent} id={`forms`}>
            {formList}
          </p>
        </Fragment>
      );
