...
const AUTH0_CALLBACK_URL = 'https://localgov.fyi/app/auth/callback'
const AUTH0_DB_CONNECTION_NAME = 'Username-Password-Authentication'
const AUTH0_LOGOUT_RETURN_TO = 'https://localgov.fyi/'
const AUTH0_AUDIENCE = 'weopely-weopenly-prod'
