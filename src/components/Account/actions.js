...
export function toggleRegister(toggle) {
    return {type: types.TOGGLE_REGISTER_DIALOG, toggle}
}

export function toggleLogin(toggle) {
    return {type: types.TOGGLE_LOGIN_DIALOG, toggle}
}

export function toggleLoginStatus(toggle) {
